<template>
	...
	<div class="collapsible-body pl pr">
		...
		<div class="input-field ta-l">
			<ui-select label="Tipo de infecção" :val.sync="config.infectBy">
			</ui-select>
		</div>

<!-- 		<div v-if="config" class="input-field ta-l">
			<select name="config.infectBy" v-select="config.infectBy">
 ...
 -->
		...
		<ul v-if="config" class="collection z-depth-1 mb">
